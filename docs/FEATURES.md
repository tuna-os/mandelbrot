...
![The call view, with a participant grid](guide/call-view.png)
...
![The QR code login page](guide/login-qr-code.png)
...
![The thread panel open beside a room timeline](guide/room-thread-panel.png)
...
![The create-poll dialog](guide/create-poll.png)
...
![A voice message in the timeline, with its duration and waveform](guide/room-timeline.png)
...
Every image on this page is generated by the screenshot walkthrough rather than
captured by hand — see [`docs/guide/README.md`](guide/README.md) for how they
